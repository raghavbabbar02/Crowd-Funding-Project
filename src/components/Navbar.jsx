  ...
  return (
    <div className='flex md:flex-row flex-col-reverse justify-between mb-[35px] gap-6'>
        <div className='lg:flex-1 flex flex-row max-w-[458px] py-2 pl-4 pr-2 h-[52px] bg-[#1c1c24]'>
            <input type="text" placeholder='Search for campaigns' className='w-full font-epilogue text-[14px] placeholder:text-[#4b5264] text-white bg-transparent outline-none' />
        ...
        <div className='sm:hidden flex justify-between items-center relative'>
            <div className='w-[40px] h-[40px] flex rounded-[10px] bg-[#2c2f32] justify-center items-center cursor-pointer'>
                <img src={thirdweb} alt="user" className='w-[60%] h-[60%] object-contain' />
            </div>
